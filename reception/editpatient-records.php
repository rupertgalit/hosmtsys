	...
	<?php
	 ...
	 ?>
		<div id="content" class="p-4 p-md-5 pt-5">
			<a href="patients-records.php" style="margin-left:10px;"><button class="btnlink">View Patients</button></a><br><br>
			<?php $id = $_GET['patient_id']; ?>
			<center>
				<form action="editpatient-records.php?patient_id=<?php echo $id; ?>" method="POST">
				<?php
