...
<body>
	...
	<?php
	 ...
	 <div id="content" class="p-4 p-md-5 pt-5">
		<div class="right">
			<br><form action="search.php" method="get" style="float:left;margin-left:15px;"><input type="text" style="height:35px; width:200px;padding-left:15px;" name="s" placeholder="Search Patient By Name"></form><br><br>
